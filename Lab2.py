...
"""
Refer: https://github.com/mgarrett57/DENCLUE
"""
...
class DENCLUE(BaseEstimator, ClusterMixin):
    ...
    def __init__(self, bandwidth=0.25, tolerance=1e-8, min_density=0., metric='euclidean'):
        self.h = bandwidth
        self.eps = tolerance
    ...
    def fit(self, X, y=None, sample_weight=None):
        ...
        clusters = list(_connected_component_subgraphs(g_clusters))
        num_clusters = 0
...
# refer: https://stackoverflow.com/questions/34047540/python-clustering-purity-metric
...
for k,v in cluster_info.items():
    print('cluster {}, attractor: {}, set of point: {}'.format(k, v['centroid'], v['instances']))
...
print('Purity of the clustering: {}'.format(purity))
print('#' * 50)
# In[ ]:
